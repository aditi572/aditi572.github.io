...
<!--
    <center>  <aside class="column">
      ...
      <a><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTxJd0fRTzNTJUgriwYGdNY7xnrCEtR9sEKs2qnT-HID3jAfNUq&usqp=CAU"  alt="about_photo"></a>
    ...
    <center><section class="hello">
      ...
      <p>A lot of people love to read books and novels but find it difficult to purchase or want don't want to buy a new book every time and save some money. Plus no e-book can ever replace the scent or feel of reading a book while holding it in your hands.</p>
      <p>Calipso Bookstore is a haven for book lovers. You can put your own old/used books for lending and borrow books from other users, that too completely free of cost!</p>
      <p>So, what are you waiting for? Start searching for the books you want to read now!  </p>
  </section></center>
    <div>
      <h3>About the developer</h3>
    This website is developed by Aditi Gupta. </div>
